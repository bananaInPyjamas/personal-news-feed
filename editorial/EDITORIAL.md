...
- Modello esclusivamente editoriale: `gpt-6-astra`, reasoning effort `high`, per ricerca, verifica dei fatti, selezione, headline e sintesi. Non usare Astra per sviluppo, controlli tecnici, Git, distribuzione o verifica del sito.
- Per implementazione e controlli tecnici usare un modello più semplice: `gpt-5.6-luna` come scelta iniziale, insieme a script deterministici per le verifiche ripetitive. Se insufficiente, segnalare il problema senza passare automaticamente ad Astra. La verifica giornalistica dei fatti resta responsabilità dell'editore Astra.
